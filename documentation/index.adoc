...
:toclevels: 3
:sectnumlevels: 5
//:leveloffset: 1 TODO: enable this line when documentation is complete
:icons: font
...
The IoT Broker is one of three types of brokers of a Silicon Economy Platform.
This documentation contains the description of all IoT Broker Components, their context, interaction, constraints and implementation.
